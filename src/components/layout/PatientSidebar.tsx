...
function groupBySection() {
  const groups = new Map<string, typeof patientNavigation>()

  patientNavigation.forEach((item) => {
...
export function PatientSidebar({ fullName, patientId }: PatientSidebarProps) {
